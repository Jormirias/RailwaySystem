...
public class BinarySearchTree<K extends Comparable<K>, V>
    ...
    public V insert(K key, V value) {
        ...
        if (node == null || node.getElement().getKey().compareTo(key) != 0) { // Key does not exist, node is "parent"
     ...
     * @param middle     node that is to be removed, child of parent, parent of
     *                   grandchild
     */
