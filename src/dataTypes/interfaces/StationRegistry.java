...
public interface StationRegistry extends Serializable {
     ...
     */
    void addTrainTime(Time departureTime, int train, Time time);

    /**
     * Remove a train time from the StationRegistry.
     * @param train - id of the train to be removed.
     */
    void removeTrainTime(TrainTime train);
     ...
     */
    Iterator<Entry<String, String>> getLines();
     ...
     */
    Iterator<Entry<TrainTime, Time>> getTrainTimes();
